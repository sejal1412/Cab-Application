...
public class Registration extends JDialog {
	...
	public Registration() {
		...
		contentPanel.setLayout(null);
			...
			Image reg = new ImageIcon(this.getClass().getResource("cab_booking/Icons/sign_up.jpg")).getImage();
			//ImageIcon reg = new ImageIcon(System.getProperty("user.dir") + "cab_booking/Icons/sign_up.jpg");
